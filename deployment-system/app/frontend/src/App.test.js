...
describe("Books CRUD using booksApi mock", () => {
  it("loads empty list on start", async () => {
    ...
    // page title
    expect(
      screen.getByRole("heading", { name: /library manager/i })
    ).toBeInTheDocument();
  });
  ...
  it("creates a book", async () => {
    ...
    // POST /books
    booksApi.create.mockResolvedValueOnce({
      id: 1,
      title: "Test",
      author: "Author",
    });
  ...
  it("updates a book", async () => {
    ...
    // PUT /books/1
    booksApi.update.mockResolvedValueOnce({
      id: 1,
      title: "Updated",
      author: "Author",
    });
    ...
    booksApi.list.mockResolvedValueOnce([
      { id: 1, title: "Updated", author: "Author" },
    ]);
